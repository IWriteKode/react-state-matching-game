  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <OptionsPanel startGame = {this.startGame } playing={state.playing} numTiles ={state.numTiles} />
        <Board numTiles ={state.numTiles} tiles = {state.tiles}/>
